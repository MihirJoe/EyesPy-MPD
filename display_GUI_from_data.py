...
class EyeTrackingGUI:
    def __init__(self, root):  #...root, image_folder) add folder as another argument
        ...
        # Image Folder
        self.image_folder = "/Users/aditi/Desktop/MPD/EyesPy-MPD/examples_for_gui"
    ...
    def get_eye_image_pairs(self):
        ...
        for file in files:
            if "left_eye" in file:
                subject_id = file.replace("_left_eye.jpg", "")
                right_eye_file = f"{subject_id}_right_eye.jpg"
...
if __name__ == "__main__":
    root = tk.Tk()
    app = EyeTrackingGUI(root) #pass file name
    root.mainloop()
